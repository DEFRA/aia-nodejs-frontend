...
describe('resolveUser', () => {
  ...
  beforeEach(() => {
    ...
    vi.doMock(
      '../../../../src/server/common/helpers/backend-headers.js',
      () => ({
  ...
  afterEach(() => {
    ...
    vi.doUnmock('../../../../src/server/common/helpers/backend-headers.js')
  })
  ...
  async function getResolveUser() {
    const mod =
      await import('../../../../src/server/common/helpers/user-resolver.js')
